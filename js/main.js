...
const SKILLS = [
  ...
  { name: "Navisworks Management", level: 70 },
  { name: "AutoDesk AutoCAD", level: 70 },
  { name: "Microsoft Office", level: 80 },
];

const FRAMEWORKS = [
  "AutoDesk Revit", "AutoDesk AutoCAD", "Navisworks Management", "Microsoft Office", "AutoDesk Maya", 
  "Blender", "ZBrush", "Adobe Substance 3D Painter", "Adobe Photoshop", "Adobe Illustrator", "Adobe Premiere", "Adobe After Effects", "Figma",
];
...
const CERTIFICATES = [
  { title: "BIM Revit MEPF Certificate", org: "RevitTech" },
  { title: "Google UX Design Professional Certificate", org: "Coursera" },
  { title: "Microsoft Office Specialist Certificate (MOS)", org: "Microsoft" },
];
...
function initMatrix() {
  ...
  const chars = "100110011000111001100110011001";
  const fontSize = 14;
...
function initContactForm() {
  ...
  form?.addEventListener("submit", (e) => {
    ...
    window.location.href = `mailto:manghi.work@gmail.com?subject=${subject}&body=${body}`;
  });
}
